...
struct cutlass_3x_gemm2 {
  ...
  using KernelType = cutlass::gemm::kernel::GemmUniversal<
      cute::Shape<int, int, int, int>, CollectiveMainloop, CollectiveEpilogue, TileSchedule>;

  struct GemmKernel : public KernelType {};
};

template <typename Gemm>
inline void cutlass_scaled_mm_dispatcher(torch::Tensor &out, torch::Tensor const &a,
  ...
  typename GemmKernel::Arguments args{Gemm::Mode,
